...
public class IdMaker {
    public static Integer BranchIdMaker(){
        ...
        for (int i = 0; i < 2; i++) { stringBuilder.append((int)Math.floor(Math.random()*(10-1)+1)); }
        return Integer.parseInt(stringBuilder.toString());
    }
    public static Integer ProfessionIdMaker(){
        StringBuilder stringBuilder = new StringBuilder();
        for (int i = 0; i < 3; i++) { stringBuilder.append((int)Math.floor(Math.random()*(10-1)+1)); }
        return Integer.parseInt(stringBuilder.toString());
    }
    ...
    public static Integer Teacher_ClassIdMaker(){
        StringBuilder stringBuilder = new StringBuilder();
        for (int i = 0; i < 5; i++) { stringBuilder.append((int)Math.floor(Math.random()*(10-1)+1));}
        return Integer.parseInt(stringBuilder.toString());
    }
    ...
    public static Integer GradeIdMaker(){
        StringBuilder stringBuilder = new StringBuilder();
        for (int i = 0; i < 8; i++) {stringBuilder.append((int)Math.floor(Math.random()*(10-1)+1));}
        return Integer.parseInt(stringBuilder.toString());
    }
}
